...
:::tip[هنوز نمونه خود را ندارید؟]
نشان‌ها را در دموی عمومی ما امتحان کنید: [demo-xray-checker.kutovoy.dev](https://demo-xray-checker.kutovoy.dev/). از پروکسی‌های دمو برای آزمایش سبک‌های مختلف نشان استفاده کنید.
:::
...
| `transparent` | `true`, `false` | `false` | پس‌زمینه شفاف |
