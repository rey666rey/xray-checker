...
- با فایروال‌های دارای محدودیت شدیدتر کار می‌کند
...
3. حداقل بایت‌های دریافتی را بررسی می‌کند
...
- از **ip** به عنوان قابل اطمینان‌ترین روش تأیید اتصال استفاده کنید (پیش‌فرض)
