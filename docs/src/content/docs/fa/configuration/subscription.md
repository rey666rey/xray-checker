...
Xray Checker از پنج فرمت مختلف برای پیکربندی پروکسی پشتیبانی می‌کند. از [متغیر محیطی](/fa/configuration/envs#subscription_url) `SUBSCRIPTION_URL` برای راه‌اندازی استفاده کنید.
...
- آدرس HTTPS
- محتوای کدگذاری شده Base64 را برمی‌گرداند
- محتوا آدرس‌های پروکسی جدا شده با خط جدید است
- از هدرهای استاندارد User-Agent پشتیبانی می‌کند
