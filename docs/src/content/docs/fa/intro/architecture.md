...
6. **سیستم نشان**
   - تولید نشان‌های وضعیت قابل جاسازی
   - پشتیبانی از چندین تم و سبک
   - به‌روزرسانی وضعیت در لحظه

7. **مدیر ایستا**
   - مدیریت فایل‌های سفارشی (لوگو، فاویکون، CSS)
   - پشتیبانی از جایگزینی کامل قالب
   - سیستم اورلی (فایل‌های سفارشی اولویت دارند)
...
ارائه نشانگرهای وضعیت قابل جاسازی:

- تولید نشان بر اساس پارامترهای URL
- سبک‌های بصری متعدد (default، flat، pill، dot)
- پشتیبانی از تم (تاریک/روشن)
- گزینه‌های نمایش قابل تنظیم

### مدیر ایستا

مدیریت سفارشی‌سازی رابط وب:

- بارگذاری لوگو و فاویکون سفارشی
- تزریق CSS برای سفارشی‌سازی استایل‌ها
- پشتیبانی از جایگزینی کامل قالب
- کش کردن فایل‌ها هنگام راه‌اندازی
...
- حالت عمومی برای صفحات وضعیت (پنهان کردن داده‌های حساس)
