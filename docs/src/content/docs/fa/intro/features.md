...
- 🌓 رابط وب با تم تاریک/روشن برای نظارت بر وضعیت تمام نقاط پایانی پروکسی
...
- 📋 [پشتیبانی از فرمت‌های مختلف پیکربندی](/fa/configuration/subscription):
  ...
  - 🔗 اشتراک‌های URL (با پشتیبانی از چندین URL)
  - 🔐 رشته‌های کدگذاری شده Base64
  - 📄 فایل‌های JSON V2Ray/Xray
  - 📦 آرایه JSON Xray (چند پیکربندی)
  - 📁 پوشه‌های پیکربندی
...
- ⏱️ [شبیه‌سازی تأخیر](/fa/configuration/advanced-conf) برای نقاط پایانی جهت اطمینان از تست دقیق سیستم نظارتی
...
- 🔧 [پشتیبانی از سه روش تأیید پروکسی](/fa/configuration/check-methods):

  - 🌐 از طریق مقایسه آدرس IP
  - ✅ از طریق بررسی‌های وضعیت HTTP
...
- 🛡️ [محافظت از متریک‌ها و رابط وب](/fa/configuration/advanced-conf#security-settings) با استفاده از احراز هویت پایه
