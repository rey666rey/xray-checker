...
Xray Checker هم نقاط پایانی HTTP عمومی و هم محافظت شده ارائه می‌دهد. نقاط پایانی محافظت شده وقتی `METRICS_PROTECTED=true` نیاز به احراز هویت دارند.
...
وقتی فعال باشد (`METRICS_PROTECTED=true`)، نقاط پایانی محافظت شده نیاز به احراز هویت پایه دارند:
